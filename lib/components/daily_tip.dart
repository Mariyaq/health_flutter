...
class DailyTip extends StatelessWidget {
  final Map<String, String> element = {
    'title': '3 основных совета по тренировкам',
    'subtitle':
        'Американский совет по физическим упражнениям (ACE) недавно провел опрос 3000 сертифицированных ACE персональных тренеров на предмет лучших!',
